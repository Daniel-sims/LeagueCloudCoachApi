...
{
    public class REPLACED_ChampionStaticDataRepository : REPLACED_IChampionStaticDataRepository
    {
        //private REPLACED_LccDatabaseContext _lccDatabaseContext;

        //public ChampionStaticDataRepository(REPLACED_LccDatabaseContext lccDatabaseContext)
        //{
