...
{
    public class RunesReforgedStaticDataRepository : IRunesReforgedStaticDataRepository, IDisposable
    {
        private LccDatabaseContext _lccDatabaseContext;

        public RunesReforgedStaticDataRepository(LccDatabaseContext lccDatabaseContext)
        {
