...
{
    public class REPLACED_SummonerSpellStaticDataRepository : REPLACED_ISummonerSpellStaticDataRepository
    {
        //private REPLACED_LccDatabaseContext _lccDatabaseContext;

        //public SummonerSpellStaticDataRepository(REPLACED_LccDatabaseContext lccDatabaseContext)
        //{
